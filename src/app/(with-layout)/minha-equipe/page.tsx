...
import { ArrowLeft, ArrowRight, Construction, User, Users } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      {showSupervisorsList ? (
        ...
        // Supervisor → Tela da equipe dele (em construção)
        <div className="flex flex-1 flex-col items-center justify-center gap-6 text-center">
          ...
          >
            Em breve você poderá gerenciar os membros da sua equipe de
            atendimento. Adicione, remova e visualize os membros vinculados a
            você.
          </Text>
