...
import { supervisorsTitlesColumns } from './columns-supervisors'

interface DataTableToolbarProps<TData> {
  table: Table<TData>
}

export function DataTableSupervisorsToolbar<TData>({
  table,
  ...
  return (
    <div className="grid grid-rows-2 gap-3 lg:grid-cols-[.5fr_.5fr_1fr] lg:grid-rows-1">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <DataTableViewOptions titles={supervisorsTitlesColumns} table={table} />
      </div>
    </div>
  )
}
