  ...
  variants: {
    variant: {
      'advertence-32-72-700':
        'font-manrope text-[32px] leading-[40px] font-bold tracking-normal sm:text-6xl sm:leading-none sm:tracking-normal lg:text-7xl',
      'headline-24-45-700':
        'font-manrope text-[24px] leading-[32px] font-bold tracking-normal sm:text-[32px] sm:leading-[40px] lg:text-[45px] lg:leading-[52px]',
      'headline-24-45-500':
        'font-manrope text-[24px] leading-[32px] font-medium tracking-normal sm:text-[32px] sm:leading-[40px] lg:text-[45px] lg:leading-[52px]',
      'title-22-36-500':
        'font-manrope text-[22px] leading-[28px] font-medium tracking-normal sm:text-[32px] sm:leading-[40px] lg:text-[36px] lg:leading-[44px]',
      'title-22-32-700':
        'font-manrope text-[22px] leading-[28px] font-bold tracking-normal sm:text-[24px] sm:leading-[32px] lg:text-[32px] lg:leading-[40px]',
      'title-22-32-500':
        'font-manrope text-[22px] leading-[28px] font-medium tracking-normal sm:text-[24px] sm:leading-[32px] lg:text-[32px] lg:leading-[40px]',
      'title-18-24-700':
        'font-manrope text-[18px] leading-[24px] font-bold tracking-[0.15px] md:text-[22px] md:leading-[28px] md:tracking-normal lg:text-[24px] lg:leading-[32px]',
      'title-18-24-500':
      ...
      'title-14-16-500':
        'font-manrope text-[14px] leading-[20px] font-medium tracking-[0.1px] lg:text-[16px] lg:leading-[24px] lg:tracking-[0.15px]',
      'body-16-24-400':
        'font-manrope text-[16px] leading-[24px] font-normal tracking-[0.5px] lg:text-[24px] lg:leading-[32px] lg:tracking-normal',
      'body-16-18-400':
        'font-manrope text-[16px] leading-[24px] font-normal tracking-[0.5px] lg:text-[18px] lg:tracking-[0.15px]',
      'body-16-16-400':
        'font-manrope text-[16px] leading-[24px] font-normal tracking-[0.5px]',
      'label-14-16-400':
        'font-manrope text-[14px] leading-[20px] font-normal tracking-[0.1px] lg:text-[16px] lg:leading-[24px] lg:tracking-[0.5px]',
      'label-14-14-400':
        'font-manrope text-[14px] leading-[20px] font-normal tracking-[0.1px]',
      'button-14-14-500':
        'font-manrope text-[14px] leading-[20px] font-medium tracking-[0.1px]',
    },
    size: {
