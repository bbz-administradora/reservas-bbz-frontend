...
export const getUploadImageUrl = (params: UploadImageParams) => {
  ...
  return normalizedParams.size
    ? `${process.env.NEXT_PUBLIC_API_URL}/v1/private/image/s3/upload?${normalizedParams.toString()}`
...
export const uploadImage = async (
  ...
  return customFetch<Promise<uploadImageResponse>>(getUploadImageUrl(params), {
    ...options,
    method: 'POST',
    body: formData,
  })
...
export const deleteImage = async (
  ...
  return customFetch<Promise<deleteImageResponse>>(getDeleteImageUrl(), {
    ...options,
    method: 'DELETE',
